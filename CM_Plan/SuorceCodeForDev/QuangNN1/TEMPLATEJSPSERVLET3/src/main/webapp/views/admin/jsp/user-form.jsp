				...
				<div class="row mx-1">
					<div class="col-xl-4 col-lg-4 col-sm-6 col-12">
						<div class="form-group row mt-3">
							<label for="" class="col-4 col-form-label">User Name</label>
							<div class="col-8">
					...
					<div class="col-xl-4 col-lg-4 col-sm-6 col-12">
						<div class="form-group row mt-3">
							...
							<div class="col-8">
								<input class="form-control" name="fullName" maxlength="25" />
							</div>
						</div>
						<!-- ================ -->
						<div class="text-danger" id="messageFullName">Message
							Here!!!</div>
					...
					<div class="col-xl-4 col-lg-4 col-sm-6 col-12">
						<div class="form-group row mt-3">
							<label for="" class="col-4 col-form-label">Password <span
								class="text-danger">&#10033;</span></label>
							<div class="col-8">
								<input class="form-control" name="password" maxlength="25" />
							</div>
						</div>
					...
					<div class="form-group row mt-3">
						...
						<div class="col-8">
							<select class="form-control" name="roleId">
								<option class="form-control" value="2">Member</option>
		...
		<div class="w-100 row mx-auto d-flex d-flex justify-content-center">
			...
			<div class="col-xl-1 col-lg-3 col-sm-3 col-6 align-self-end">
				<button type="submit" class="btn btn-outline-success btn-block"
					type="button" id="clickBack">Create</button>
			</div>
			<div class="col-xl-1 col-lg-3 col-sm-3 col-6 align-self-end">
