	...
	<article>
		...
		<main class="mx-5">
			...
			<div id="about" class="container-fluid mt-5">
				<div class="row">
					<div class="col-sm-8">
						<h1 class="text-center" style="font-family:Georgia;">SỨ MỆNH</h1>
						<br>
						...
						<br>
						<p class="px-5">VIỆT TRÍ ĐẠO mong muốn trở thành một nơi đào tạo
					...
					<div class="col-sm-4">
						<div class="px-auto d-flex justify-content-center">
							<img class="rounded-circle" style="height:250px;" alt="mrHuy" src="views/welcome/media/images/general/mrHuy.png">
						</div>
						<p class="d-flex justify-content-center mt-2"><a href="#" class="h5">Kỹ sư CNTT Nguyễn Tấn Huy</a></p>	
			...
			<div class="container-fluid mt-5">
				<div class="row">
					<div class="col-sm-4">
						<div class="px-auto d-flex justify-content-center">
							<img class="rounded-circle " style="height:250px;" alt="mrHuy" src="views/welcome/media/images/general/vkAHuy.png">
						</div>
						<p class="d-flex justify-content-center mt-2"><a href="#" class="h5">Kỹ sư CNTT Trương Thị Thanh Tâm</a></p>	
					</div>
					<div class="col-sm-8">
						<h1 class="text-center" style="font-family:Georgia;">TRIẾT LÝ ĐÀO TẠO</h1>
						<br>
						<h4 class="text-center">
						...
						<br>
						<p class="	px-5">1. Đào tạo sát với THỰC TẾ, chú trọng đến THỰC
			...
			<div id="services" class="container-fluid text-center mt-5">
				<h1 class="" style="font-family:Georgia;">DỊCH VỤ</h1>
			...
			<div class="col-xl-7 col-sm-12 mx-auto mt-5" >
				<video loop="loop" class="w-100" controls style="border: 2px solid black;"
					poster="views/welcome/media/images/general/imgBackgroudVideo.png">
			...
			<div id="contact" class="container-fluid mt-5">
				<h1 class="text-center" style="font-family:Georgia;">LIÊN HỆ</h1>
