...
<body>
	<article>
		...
		<main class="mx-5">
			...
			<div
				class="border border-success styleBorderWidth2px mx-md-4 mx-sm-2 mx-1">
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							<tr>
								...
								<td>
									<button type="button"
										class="btn btn-outline-danger clickDelete">Delete</button>
								</td>
		...
		<div class="mx-md-5 mx-sm-2 mx-1 mt-4">
			<div class="row mx-5">
				<div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 mt-1">
					<div class="px-1 py-2" style="font-weight: 500;">Totals: 999
						Results / 999 Pages</div>
				</div>
				<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mt-1">
					<div class="btn-group">
				...
				<div
					class="col-xl-4 col-lg-12 col-md-12 col-sm-12 overflow-auto text-center mt-1">
					<ul class="pagination w-100 mx-auto" id="pagination"></ul>
				</div>
				<div class="col-xl-1 col-lg-3 col-md-4 col-sm-4 mt-1">
					<a href="/addUser-view">
