					...
					<div class="media-body mt-3">
						...
						<div class="btn-group pl-2" role="group"
							...
							<button class="btn btn-sm like_click_OtherJs " 
								...
								<span class="likeNum">1233</span>
							</button>
							<button class="btn btn-sm disLike_click_OtherJs" style="border-radius: 5px 5px;">
								<i class="fa fa-thumbs-o-down disLikeNumBackground" 
									style="font-size: 24px;"></i>
								<span class="disLikeNum">12</span>
							</button>
							...
							<button id="bookMark_click" class="btn btn-sm" style="border-radius: 5px 5px;">
