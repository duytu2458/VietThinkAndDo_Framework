	...
	<article>
		...
		<main class="mx-5">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<p>1. Đào tạo sát với THỰC TẾ, chú trọng đến THỰC
							HÀNH. 2. Lấy HỌC VIÊN làm TRUNG TÂM. 3. Xem trọng đào tạo
							KỸ NĂNG MỀM và rèn luyện khả năng TƯ DUY. 4. Không dạy
							thừa, DẠY VỪA ĐỦ nhưng phải SÂU. 5. KHÔNG BẮT BUỘC học
							viên phải đóng HỌC PHÍ TRỌN GÓI. 6. Sẵn sàng hợp tác
							với PHỤ HUYNH. 7. GIẢNG VIÊN cũng là HỌC VIÊN. 8. KHÔNG CÓ
			...
			<div id="contact" class="container-fluid mt-3">
				...
				<p class="text-center text-primary h4">Chúng tôi sẽ liên hệ lại bạn trong vòng 24h</p>
				<div class="row">
