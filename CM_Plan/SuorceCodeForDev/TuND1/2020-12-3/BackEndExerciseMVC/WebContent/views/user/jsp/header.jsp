<header>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-info">
						...
						<a class="dropdown-item styleLogout"
							href="<%=request.getContextPath()%>/homePage?pageNum=1">Admin</a> <a
							class="dropdown-item styleLogout"
							href="<%=request.getContextPath()%>/logout">LogOut</a>
					</div></li>
			</ul>
		</div>
	</nav>
	<%-- 	<nav class="navbar navbar-expand navbar-dark" hidden="true">
	...
	<h2 class="text-center mt-3 text-success">
		<b>VietThink&Do</b>
	</h2>
