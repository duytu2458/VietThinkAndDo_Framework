					...
					<div class="media-body mt-3">
						...
						<div class="btn-group pl-2" role="group"
							...
							<button class="btn btn-sm">
								<i class="fa fa-thumbs-o-down" style="font-size: 24px"></i><span >12</span>
							</button>
							<button class="btn btn-sm">
										...
										<div class="btn-group pl-2" role="group"
											...
											<button class="btn btn-sm like_click_OtherJs">
												<i class="fa fa-thumbs-o-up"
													style="font-size: 24px; color: blue"></i><span class="likeNum">123</span>
											</button>
											<button class="btn btn-sm">
...
<script type="text/javascript">
	$(document).ready(function() {
		$(".like_click_OtherJs").click(function (){
			var numIndex = $(".like_click_OtherJs").index(this);
			var numLikeObj = $(".likeNum").eq(numIndex);
			var numLike = parseInt(numLikeObj.text())+1;
			numLikeObj.text(numLike);
			
			if(numLikeObj.css("color") == "rgb(33, 37, 41)"){
				$(".likeNumBackground").eq(numIndex).css("color","rgb(0,0,0)");
			}
		});

 		/* $(".like_click_OtherJs").toggle(
 		 	function (){
 				alert("asdasd");
 	 		},
 	 		function (){
