...
import com.hainv.model.BusinessUnit;
import com.hainv.model.Contract;
import com.hainv.model.Product;
import com.hainv.model.Project;
import com.hainv.parameters.FieldSetting;
...
public class DataGenerator {
    ...
    public static List<Contract> genContracts() throws CustomizeException {
        ...
        try {
            ...
            throw new CustomizeException(CustomizeErrorCode.PARSEEXCEPTION, e);
        }
        return contracts;
    }
